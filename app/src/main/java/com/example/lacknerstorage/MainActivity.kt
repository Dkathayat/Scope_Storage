...
import com.example.lacknerstorage.DataModel.InternalStoragePhoto
import com.example.lacknerstorage.DataModel.SharedStoragePhoto
import com.example.lacknerstorage.DataModel.sdk29AndUp
import com.example.lacknerstorage.databinding.ActivityMainBinding
            ...
            lifecycleScope.launch {
                ...
                val isSavedSuccessfully = when {
                    isPrivate -> it?.let { it1 ->
                        savePhotoToInternalStorage(UUID.randomUUID().toString(),
                            it1
                        )
                    }
                    writePermissionGranted -> it?.let { it1 ->
                        savePhotoToExternalStorage(UUID.randomUUID().toString(),
                            it1
                        )
                    }
                    else -> false
